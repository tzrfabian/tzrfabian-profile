...
<div>
  ...
  <section className="rounded-md px-4 py-12">
    <div className="grid md:grid-cols-2 justify-between items-center max-w-5xl mx-auto">
    <div className="hidden lg:block">
      <h4 className="text-white font-semibold mb-3 text-xl">You can reach me at:</h4>
      <ul className="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
          <li className="flex items-center p-2.5 font-semibold text-sm gap-x-2 text-gray-200 border border-white rounded-md hover:text-cyan-600 hover:bg-black hover:border-cyan-800">
          <Link href="https://github.com/tzrfabian" className="flex items-center">
          ...
          <li className="flex items-center p-2.5 font-semibold text-sm gap-x-2 text-gray-200 border border-white rounded-md hover:text-cyan-600 hover:bg-black hover:border-cyan-800">
          <Link href="https://www.linkedin.com/in/fabiantenzara/" className="flex items-center">
  ...
  <section id="about" className="my-40 rounded-md px-4 py-12">
    <div className="grid md:grid-cols-2 justify-between items-center max-w-5xl mx-auto">
      <div className="max-md:text-center">
        <h2 className="md:text-4xl text-slate-100 text-4xl font-semibold md:!leading-[50px] mb-2">
          About Me 👾
        ...
        My fullname is Muhammad Habib Fabian Tenzara, but my friends call me Fabian. I am a computer science graduate from Bina Nusantara University.
        </p>
      </div>
      <div>
        <img
