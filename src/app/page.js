  ...
  <div className="max-w-5xl mx-auto text-center lg:text-left">
    <div className="flex flex-col items-center">
      ...
      <ul className="flex flex-row gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        <li className="flex items-center text-center p-2.5 font-semibold text-sm gap-x-2 text-gray-200 border border-white rounded-md hover:text-cyan-600 hover:bg-black hover:border-cyan-800">
          <Link href="https://github.com/tzrfabian" target="_blank" rel="noopener noreferrer" className="flex items-center text-center w-20">
